package com.widget.titlebar.widget;
...
import com.widget.R;
import com.widget.titlebar.statusbar.StatusBarUtils;
import com.widget.titlebar.utils.ScreenUtils;
...
public class CustomTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        ...
        titleBarHeight = (int) array.getDimension(R.styleable.CustomTitleBar_titleBarHeight, ScreenUtils.dp2PxInt(context, 44));
        ...
        bottomShadowHeight = array.getDimension(R.styleable.CustomTitleBar_bottomShadowHeight, ScreenUtils.dp2PxInt(context, 0));

        leftType = array.getInt(R.styleable.CustomTitleBar_leftType, TYPE_LEFT_NONE);
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            leftText = array.getString(R.styleable.CustomTitleBar_leftText);
            leftTextColor = array.getColor(R.styleable.CustomTitleBar_leftTextColor, getResources().getColor(R.color.titlebar_text_selector));
            leftTextSize = array.getDimension(R.styleable.CustomTitleBar_leftTextSize, ScreenUtils.dp2PxInt(context, 16));
            ...
            leftImageResource = array.getResourceId(R.styleable.CustomTitleBar_leftImageResource, R.drawable.titlebar_reback_selector);
        ...
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            ...
            rightTextColor = array.getColor(R.styleable.CustomTitleBar_rightTextColor, getResources().getColor(R.color.titlebar_text_selector));
            rightTextSize = array.getDimension(R.styleable.CustomTitleBar_rightTextSize, ScreenUtils.dp2PxInt(context, 16));
        ...
        centerType = array.getInt(R.styleable.CustomTitleBar_centerType, TYPE_CENTER_NONE);
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            centerTextSize = array.getDimension(R.styleable.CustomTitleBar_centerTextSize, ScreenUtils.dp2PxInt(context, 18));
            ...
            centerSubTextSize = array.getDimension(R.styleable.CustomTitleBar_centerSubTextSize, ScreenUtils.dp2PxInt(context, 11));
            ...
            centerSearchBgResource = array.getResourceId(R.styleable.CustomTitleBar_centerSearchBg, R.drawable.titlebar_search_gray_shape);
